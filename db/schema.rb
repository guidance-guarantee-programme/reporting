...
ActiveRecord::Schema.define(version: 20180719183520) do
  ...
  create_table "appointment_summaries", id: :serial, force: :cascade do |t|
    ...
    t.index ["delivery_partner"], name: "index_appointment_summaries_on_delivery_partner"
    t.index ["year_month_id"], name: "index_appointment_summaries_on_year_month_id"
  end

  create_table "appointment_versions", id: :serial, force: :cascade do |t|
  ...
  create_table "appointments", id: :serial, force: :cascade do |t|
    ...
    t.index ["version"], name: "index_appointments_on_version"
  end
  ...
  create_table "code_lookups", id: :serial, force: :cascade do |t|
    t.string "from"
    t.string "to"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["from"], name: "index_code_lookups_on_from", unique: true
  end

  create_table "cost_items", id: :serial, force: :cascade do |t|
  ...
  create_table "costs", id: :serial, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "year_month_id", default: 0, null: false
    t.index ["cost_item_id"], name: "index_costs_on_cost_item_id"
    t.index ["user_id"], name: "index_costs_on_user_id"
    t.index ["year_month_id"], name: "index_costs_on_year_month_id"
  end

  create_table "daily_call_volumes", id: :serial, force: :cascade do |t|
    t.string "source"
    t.date "date"
    ...
    t.index ["date"], name: "index_daily_call_volumes_on_date", unique: true
  end

  create_table "satisfactions", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "sms_response", default: 0, null: false
  ...
  create_table "where_did_you_hears", id: :serial, force: :cascade do |t|
    t.datetime "given_at", null: false
